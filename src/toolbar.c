...
TBBUTTON at_button[] =                
    {
        ...
        {I_IMAGENONE , -1, TBSTATE_ENABLED, TBSTYLE_SEP|TBSTYLE_AUTOSIZE},
        {I_IMAGENONE , -1, TBSTATE_ENABLED, TBSTYLE_SEP|TBSTYLE_AUTOSIZE},
        {0, IDT_TOOLBAR_BUTTON1, TBSTATE_ENABLED, TBSTYLE_AUTOSIZE , {0}, 0, (int)"这是按纽1"},
        {1, IDT_TOOLBAR_BUTTON2, TBSTATE_ENABLED, TBSTYLE_AUTOSIZE , {0}, 0, (int)"这是按纽2"},
        {I_IMAGENONE , -1, TBSTATE_ENABLED, TBSTYLE_SEP|TBSTYLE_AUTOSIZE},
        {2, IDT_TOOLBAR_BUTTON3, TBSTATE_ENABLED, TBSTYLE_AUTOSIZE , {0}, 0, (int)"这是按纽3" },
    };
